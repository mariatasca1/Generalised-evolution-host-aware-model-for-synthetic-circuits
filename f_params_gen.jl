...
# when expressing synthetic genes. For more
...
function f_params_gen(active_dims)

num_genes = div(length(active_dims) ,2); # Number of added genes
...
protein_length = 300
length_protein = fill(protein_length, num_genes)     # Length of proteins (aa/molecs) 
...
base_params = vcat([num_genes,N, mass, nut, nq, v_e, K_e, n_R, n_Z, n_Q], length_protein, 
